...
box_Calcfoam = PointVolumeInterpolator(registrationName='Box_Calcfoam', Input=base_Calcfoam,
...
calculator1 = Calculator(registrationName='Vector_Uxy_Uyz_Uzx', Input=box_Calcfoam)
...
# create a new 'Slice'
slice_Mean_xy = Slice(registrationName='Slice_Mean_xy', Input=temporalStatistics11)
...
# create a new 'Slice'
slice_Mean_yz = Slice(registrationName='Slice_Mean_yz', Input=temporalStatistics12)
...
# create a new 'Slice'
slice_Mean_zx = Slice(registrationName='Slice_Mean_zx', Input=temporalStatistics13)
...
# create a new 'Slice'
slice_Cov_xy = Slice(registrationName='Slice_Cov_xy', Input=calculator11)
...
# create a new 'Slice'
slice_Cov_yz = Slice(registrationName='Slice_Cov_yz', Input=calculator12)
...
# create a new 'Slice'
slice_Cov_zx = Slice(registrationName='Slice_Cov_zx', Input=calculator13)
...
calculator2 = Calculator(registrationName='Vector_Uxx_Uyy_Uzz', Input=box_Calcfoam)
...
# create a new 'Slice'
slice_Mean_xx = Slice(registrationName='Slice_Mean_xx', Input=temporalStatistics21)
...
# create a new 'Slice'
slice_Mean_yy = Slice(registrationName='Slice_Mean_yy', Input=temporalStatistics22)
...
# create a new 'Slice'
slice_Mean_zz = Slice(registrationName='Slice_Mean_zz', Input=temporalStatistics23)
...
# create a new 'Slice'
slice_Cov_xx = Slice(registrationName='Slice_Cov_xx', Input=calculator21)
...
# create a new 'Slice'
slice_Cov_yy = Slice(registrationName='Slice_Cov_yy', Input=calculator22)
...
# create a new 'Slice'
slice_Cov_zz = Slice(registrationName='Slice_Cov_zz', Input=calculator23)
...
# show data from box_Calcfoam
box_CalcfoamDisplay = Show(box_Calcfoam, renderView1, 'UnstructuredGridRepresentation')
...
box_CalcfoamDisplay.Representation = 'Surface'
box_CalcfoamDisplay.ColorArrayName = ['POINTS', 'U']
box_CalcfoamDisplay.LookupTable = uLUT
box_CalcfoamDisplay.Opacity = 0.6
box_CalcfoamDisplay.PointSize = 1.0
box_CalcfoamDisplay.SelectTCoordArray = 'None'
box_CalcfoamDisplay.SelectNormalArray = 'None'
box_CalcfoamDisplay.SelectTangentArray = 'None'
box_CalcfoamDisplay.OSPRayScaleArray = 'U'
box_CalcfoamDisplay.OSPRayScaleFunction = 'PiecewiseFunction'
box_CalcfoamDisplay.SelectOrientationVectors = 'U'
box_CalcfoamDisplay.ScaleFactor = 2.0
box_CalcfoamDisplay.SelectScaleArray = 'None'
box_CalcfoamDisplay.GlyphType = 'Arrow'
box_CalcfoamDisplay.GlyphTableIndexArray = 'None'
box_CalcfoamDisplay.GaussianRadius = 0.1
box_CalcfoamDisplay.SetScaleArray = ['POINTS', 'U']
box_CalcfoamDisplay.ScaleTransferFunction = 'PiecewiseFunction'
box_CalcfoamDisplay.OpacityArray = ['POINTS', 'U']
box_CalcfoamDisplay.OpacityTransferFunction = 'PiecewiseFunction'
box_CalcfoamDisplay.DataAxesGrid = 'GridAxesRepresentation'
box_CalcfoamDisplay.PolarAxes = 'PolarAxesRepresentation'
box_CalcfoamDisplay.ScalarOpacityFunction = uPWF
box_CalcfoamDisplay.ScalarOpacityUnitDistance = 0.315133695380462
box_CalcfoamDisplay.OpacityArrayName = ['POINTS', 'U']

# init the 'PiecewiseFunction' selected for 'OSPRayScaleFunction'
box_CalcfoamDisplay.OSPRayScaleFunction.Points = [1.05e-09, 0.0, 0.5, 0.0, 2.848, 1.0, 0.5, 0.0]

# init the 'PiecewiseFunction' selected for 'ScaleTransferFunction'
box_CalcfoamDisplay.ScaleTransferFunction.Points = [-0.51, 0.0, 0.5, 0.0, 0.67, 1.0, 0.5, 0.0]

# init the 'PiecewiseFunction' selected for 'OpacityTransferFunction'
box_CalcfoamDisplay.OpacityTransferFunction.Points = [-0.51, 0.0, 0.5, 0.0, 0.67, 1.0, 0.5, 0.0]
...
#slice_Mean_xyDisplay = Show(slice_Mean_xy, renderView1, 'UniformGridRepresentation')
...
mean_xyLUTColorBar.ComponentTitle = ' (t=[794:797])'
...
mean_yzLUTColorBar.ComponentTitle = ' (t=[794:797])'
...
mean_zxLUTColorBar.ComponentTitle = ' (t=[794:797])'
...
cov_xyLUTColorBar.ComponentTitle = ' (t=[794:797])'
...
cov_yzLUTColorBar.ComponentTitle = ' (t=[794:797])'
...
cov_zxLUTColorBar.ComponentTitle = ' (t=[794:797])'
...
mean_xxLUTColorBar.ComponentTitle = ' (t=[794:797])'
...
mean_yyLUTColorBar.ComponentTitle = ' (t=[794:797])'
...
mean_zzLUTColorBar.ComponentTitle = ' (t=[794:797])'
...
cov_xxLUTColorBar.ComponentTitle = ' (t=[794:797])'
...
cov_yyLUTColorBar.ComponentTitle = ' (t=[794:797])'
...
cov_zzLUTColorBar.ComponentTitle = ' (t=[794:797])'
...
# show data in view
Show(box_Calcfoam, renderView1)
box_CalcfoamDisplay.SetScalarBarVisibility(renderView1, True)
uLUTColorBar.Visibility = 1

SetActiveSource(box_Calcfoam)
Render()
view = GetActiveView()

Hide(box_Calcfoam, renderView1)
box_CalcfoamDisplay.SetScalarBarVisibility(renderView1, False)
uLUTColorBar.Visibility = 0
