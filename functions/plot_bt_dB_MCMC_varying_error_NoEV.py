...
def plot_bt_dB_MCMC_varying_error_NoEV(param,bt_forecast_sto_scalar,bt_forecast_sto_beta,bt_forecast_sto_a_cst_modal_dt,\
                                  bt_forecast_sto_a_NC_modal_dt, bt_forecast_deter,bt_sans_coef1,\
...
#    set (gca, 'Layer', 'top');
    ...
    bt_forecast_MEV = bt_forecast_deter
    bt_forecast_MEV = bt_forecast_MEV-bt_forecast_MEV
...
def plot_bt_dB_MCMC_varying_error_DA_NoEV(file_plots_res, \
    param, bt_tot, struct_bt_MCMC,time):
